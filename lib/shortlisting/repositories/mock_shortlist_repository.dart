...
/// In-memory shortlist repository used by unit tests. Not wired into the app
/// — see `ShortlistRepository` (Supabase-backed) for the production implementation.
class MockShortlistRepository {
